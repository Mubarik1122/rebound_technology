!function (t) {
    var o = function (o, s) {
        ...
        var h = function () {
            ...
            var i = getComputedStyle(t[0]), e = parseFloat(i[o]),
                n = "height" === o ? ["top", "bottom"] : ["left", "right"], r = [];
            ...
            var o = p.$window.scrollTop(), s = b(t, "height"), i = innerHeight, e = t.offset().top - o, n = e - i;
            return {top: {fromTop: e, fromBottom: n}, bottom: {fromTop: e + s, fromBottom: n + s}}
        }, g = function () {
            v(), y(), a = !1, i.trigger("sticky:unstick")
        }, $ = function () {
            var t = w(i), o = "top" === e.to;
            if (c) {
                ...
                var s = w(p.$parent), a = getComputedStyle(p.$parent[0]),
                ...
                (o ? l <= t.bottom.fromTop : l >= t.top.fromBottom) && function () {
                    ...
                    if (n = p.$spacer.position().left, e.isRTL) {
                        const t = i.parent().outerWidth(), o = p.$spacer.position().left;
